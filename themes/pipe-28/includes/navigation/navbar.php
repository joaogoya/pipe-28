<!-- NAVBAR --> 
    <nav id="navbar" class="navbar navbar-expand-lg bg-dark navbar-dark">
        <div class="container">
            ...
            <!-- btn toggle -->
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarPipeline" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="collapse navbar-collapse" id="navbarPipeline">
                <ul class="navbar-nav ms-auto text-center gap-2 gap-lg-3 w-100 justify-content-end align-items-center">
                    ...
                    <li class="nav-item w-100-mobile mt-3 mt-lg-0 mb-2 mb-lg-0">
                        <a class="nav-link btn-nav-accent text-center mx-auto" href="#" target="_blank"
