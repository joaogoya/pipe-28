        ...
        <div class="row g-4">
            ...
            $args = array(
                ...
                'tax_query'      => array(
                    array(
                        'taxonomy' => 'projetos',
                        'operator' => 'EXISTS', // Traz todos os posts que possuem qualquer termo da tax 'projetos'
                    ),
                ),
            );
            ...
            if ($query_projetos->have_posts()) : while ($query_projetos->have_posts()) : $query_projetos->the_post(); ?>
                    <div class="col-12">
